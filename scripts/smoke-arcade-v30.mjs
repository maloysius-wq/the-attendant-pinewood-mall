...
try{
  ...
  expect(t.machineCount===13&&t.fixtureCount===14,'expected 13 machines plus compound checkout, got '+JSON.stringify({machineCount:t.machineCount,fixtureCount:t.fixtureCount}));
