...
function genuineFx(d){
  const endDelay=Math.max(0,Math.round((d-.14)*1000));
  return `[0:a]aresample=44100,highpass=f=650,lowpass=f=2150,acompressor=threshold=0.040:ratio=12:attack=1:release=48,equalizer=f=900:t=q:w=1.0:g=4.0,equalizer=f=1550:t=q:w=.82:g=8.0,equalizer=f=2050:t=q:w=.72:g=5.0,acrusher=bits=9:mode=lin:aa=1:mix=.28,aecho=.34:.08:18:.045,loudnorm=I=-22.5:LRA=2.6:TP=-3.0,aresample=44100[voice];[1:a]aresample=44100,highpass=f=760,lowpass=f=3000,volume=.42[bed];[2:a]aresample=44100,highpass=f=820,lowpass=f=3700,atrim=duration=.135,afade=t=out:st=.050:d=.085,volume=.72[s0];[3:a]aresample=44100,highpass=f=820,lowpass=f=3700,atrim=duration=.145,afade=t=in:st=0:d=.020,afade=t=out:st=.065:d=.080,adelay=${endDelay},volume=.64[s1];[voice][bed][s0][s1]amix=inputs=4:duration=first:dropout_transition=0:normalize=0,alimiter=limit=.86,apad=pad_dur=.18[out]`;
}
function overlapFx(d){
  const endDelay=Math.max(0,Math.round((d-.14)*1000));
  return `[0:a]aresample=44100,highpass=f=590,lowpass=f=2250,acompressor=threshold=0.042:ratio=10.5:attack=1:release=52,equalizer=f=1500:t=q:w=.85:g=6.5,equalizer=f=2050:t=q:w=.75:g=4.0,acrusher=bits=9:mode=lin:aa=1:mix=.22,loudnorm=I=-22.0:LRA=2.8:TP=-2.8,aresample=44100[voice];[1:a]aresample=44100,highpass=f=720,lowpass=f=3100,volume=.34[bed];[2:a]aresample=44100,highpass=f=820,lowpass=f=3700,atrim=duration=.125,afade=t=out:st=.045:d=.080,volume=.62[s0];[3:a]aresample=44100,highpass=f=820,lowpass=f=3700,atrim=duration=.140,adelay=${endDelay},afade=t=out:st=.060:d=.080,volume=.56[s1];[voice][bed][s0][s1]amix=inputs=4:duration=first:dropout_transition=0:normalize=0,alimiter=limit=.88,apad=pad_dur=.18[out]`;
}
