...
for(const marker of [
  'window.__PINEWOOD_VISUAL_V26__={version:26','motivatedLighting:true','chapter1RetailReadability:true','chapter1ElevatorReadability:true','chapter2NavigationReadability:true','gavinReadability:true','chapterSurfaceIdentity:true',
  ...
  'new THREE.HemisphereLight(0x556a6b,0x030405,.075)','addProductionSurfaceIdentityV26(world,idx);','addProductionReadabilityV26(world,idx);'
...
console.log(`Production readability v26 PASS (${live?'LIVE-CANDIDATE':'STAGED'}): motivated Chapter 1/2 lighting remains restrained; all six chapters retain distinct mechanics/set pieces; Chapters 2–6 now receive unique wall/floor surface identities while Chapter 1 preserves authored retail materials; loader consistency and Chapter 6 prerequisite remain green.`);
